...
cancer1i=cancer1(1:350,1:9); %insieme di addestramento 9 feature / nodi di ingresso
cancer1t=2*cancer1(1:350,10)-1; % 10^ colonna target
%
% coppie per il test
...
%
%apprendimento
[u,v]=percett(cancer1i,cancer1t,50); % 50 num di iterazioni -> restituisce risultati di percett.m
%
